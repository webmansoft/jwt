...
修改于 Tinywan 的 jwt 插件
https://github.com/Tinywan/webman-jwt


[![License](http://poser.pugx.org/webmansoft/jwt/license)](https://packagist.org/packages/webmansoft/jwt) 
[![Latest Stable Version](http://poser.pugx.org/webmansoft/jwt/v)](https://packagist.org/packages/webmansoft/jwt) 
[![Total Downloads](http://poser.pugx.org/webmansoft/jwt/downloads)](https://packagist.org/packages/webmansoft/jwt)
[![Monthly Downloads](http://poser.pugx.org/webmansoft/jwt/d/monthly)](https://packagist.org/packages/webmansoft/jwt)
[![Daily Downloads](http://poser.pugx.org/webmansoft/jwt/d/daily)](https://packagist.org/packages/webmansoft/jwt)
[![PHP Version Require](http://poser.pugx.org/webmansoft/jwt/require/php)](https://packagist.org/packages/webmansoft/jwt)
...
```shell
composer require webmansoft/jwt
```
...
2、获取所有字段
```php
$email = Webmansoft\Jwt\JwtToken::getExtend();
```

3、获取自定义字段
```php
$email = Webmansoft\Jwt\JwtToken::getExtendVal('email');
```

4、获令牌有效期剩余时长
```php
$exp = Webmansoft\Jwt\JwtToken::getTokenExp();
```

5、单设备登录。默认是关闭，开启请修改配置文件`config/plugin/webmansoft/jwt`
```php
...
6、令牌清理
```php
$res = Webmansoft\Jwt\JwtToken::clear();
```
...
$token = Webmansoft\Jwt\JwtToken::generateToken($extend);
```
## 签名算法
